...
$2012R2iso="[san0_workspace] LG_SPLA_SW\SW_DVD9_Windows_Svr_Std_and_DataCtr_2012_R2_64Bit_English_-2_Core_MLF_X19-31419.ISO"

#Path to Server 2008R2 install .iso
$2008R2iso="[san0_workspace] LG_SPLA_SW\SW_DVD5_Windows_Svr_DC_EE_SE_Web_2008R2_64-bit_English_X15-59754.ISO"
...
Disconnect-VIServer -Server aspvc1 -Confirm:$false
